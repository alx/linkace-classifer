...
class LinkAceClient:
    ...
    def __init__(self, api_base_url: str, api_token: str):
        ...
        Args:
            api_base_url: Base URL of the LinkAce API (e.g., https://linkace.example.com/api/v2)
    ...
    def move_link_between_lists(self, link_id: int, from_list_id: int, to_list_id: int) -> bool:
        """
