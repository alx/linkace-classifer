...
class ClassificationService:
    ...
    def __init__(self, config: ClassifierConfig):
        ...
        self.linkace_client = LinkAceClient(
            config.linkace_api_url, 
            config.linkace_api_token
        )
    ...
    def _get_classification_lists(self) -> Dict[int, List[Dict[str, Any]]]:
        ...
        if (self._classification_lists_cache is not None and 
        ...
        for list_id in self.config.classify_list_ids:
            try:
                ...
                log_message(
                    f"Error loading list {list_id}: {e}",
                    "ERROR"
                )
    ...
    def get_service_status(self) -> Dict[str, Any]:
        ...
        if self._classification_lists_cache is not None:
            status['classification_lists']['count'] = len(self._classification_lists_cache)
    ...
    def get_classification_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            summary = {
                'total_lists': len(classify_lists_data),
                'lists': []
            }
            ...
            for list_id, links in classify_lists_data.items():
                list_info = {
                    ...
                    ))[:10]  # Show first 10 unique domains
                }
            ...
            return {
                'error': f"Error getting classification summary: {str(e)}"
            }
