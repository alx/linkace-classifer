...
Handles configuration loading from environment variables, config files, and command-line arguments
"""
    ...
    def create_config(self, args=None, config_file: str = None) -> ClassifierConfig:
        ...
        if missing_fields:
            ...
            for field in missing_fields:
                print(f"  - {field}")
            print("\nProvide these via command-line arguments, environment variables, or config file.")
            sys.exit(1)
